...
router.get('/', function(req, res) {
    res.render('index', { title: 'faculty App', user: req.user });
});
router.get('/register', function(req, res) {
    res.render('register', { title: 'faculty App Registration' });
});
...
router.get('/login', function(req, res) {
    res.render('login', { title: 'faculty App Login', user: req.user });
});
